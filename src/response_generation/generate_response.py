...
class ResponseGeneration:
    ...
    @classmethod
    def execute(cls,instruction:Instruction, specific_query, query_mapping, user_input: str, current_metadata: dict) -> str:
        """
